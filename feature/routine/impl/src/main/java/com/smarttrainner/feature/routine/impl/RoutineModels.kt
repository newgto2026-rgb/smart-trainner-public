...
internal data class RoutineUiState(
    ...
    val showCustomRoutineProgressConfirmDialog: Boolean = false,
...
internal data class RoutineActions(
    ...
    val onKeepCustomRoutineProgress: () -> Unit = {},
    val onResetCustomRoutineProgress: () -> Unit = {},
    val onDismissCustomRoutineProgressConfirm: () -> Unit = {},
