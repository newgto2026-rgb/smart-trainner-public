...
class CustomRoutineMappersTest {
    ...
    @Test
    fun customRoutineLegacyImplicitFullBodyFocusIsHidden() {
        val template = customRoutine(primaryFocus = "FULL_BODY", focus = "FULL_BODY").toPlanTemplate()
    ...
    @Test
    fun customRoutineDayInputAllowsBlankTitle() {
        val entity = CustomRoutineDayInput(
            title = "",
            focus = "",
            primaryFocus = null,
            exercises = emptyList()
