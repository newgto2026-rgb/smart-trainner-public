...
object SeedTrainingContent {
    val exercises: List<Exercise> = listOf(
        ...
        exercise("goblet_squat", "고블릿 스쿼트", MuscleGroup.LOWER_BODY, EquipmentType.DUMBBELL, DifficultyLevel.BEGINNER, "goblet_squat", "덤벨 하나로 스쿼트 패턴을 안전하게 익히는 운동입니다.", listOf("덤벨 위치: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "발·코어 정렬: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "내려가기: 통증 없는 범위에서 천천히 움직이고 반동을 쓰지 않습니다.", "올라오기: 움직임을 작게 시작해 균형과 속도를 먼저 통제합니다."), listOf("허리가 말리면 깊이를 줄이세요.", "무릎과 발끝 방향을 맞추세요."), 3, 8..12, null, 90),
        ...
        exercise("dumbbell_split_squat", "덤벨 스플릿 스쿼트", MuscleGroup.LOWER_BODY, EquipmentType.DUMBBELL, DifficultyLevel.INTERMEDIATE, "dumbbell_split_squat", "한쪽 다리씩 균형과 하체 힘을 기르는 운동입니다.", listOf("보폭 잡기: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "앞발 중심: 움직임을 작게 시작해 균형과 속도를 먼저 통제합니다.", "내려가기: 통증 없는 범위에서 천천히 움직이고 반동을 쓰지 않습니다.", "올라온 뒤 반대쪽: 앞발로 바닥을 밀어 올라온 뒤 같은 반복 수를 반대쪽 다리도 수행합니다."), listOf("무릎이 안쪽으로 꺾이면 중량을 낮추세요.", "균형이 흔들리면 맨몸부터 시작하세요."), 3, 8..10, null, 90),
        ...
        exercise("leg_extension", "레그 익스텐션", MuscleGroup.LOWER_BODY, EquipmentType.MACHINE, DifficultyLevel.BEGINNER, "leg_extension", "허벅지 앞쪽을 고립해서 느끼기 쉬운 머신 운동입니다.", listOf("패드 조정: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "무릎 펴기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "통제 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("반동으로 차올리지 마세요.", "무릎 앞쪽 통증이 있으면 범위를 줄이세요."), 3, 10..15, null, 60),
        ...
        exercise("romanian_deadlift", "루마니안 데드리프트", MuscleGroup.LOWER_BODY, EquipmentType.DUMBBELL, DifficultyLevel.INTERMEDIATE, "romanian_deadlift", "엉덩이와 햄스트링을 쓰는 힙힌지 운동입니다.", listOf("시작 위치: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "등 중립: 목과 허리에 과한 긴장이 들어가지 않게 안정적으로 유지합니다.", "힙힌지: 움직임을 작게 시작해 균형과 속도를 먼저 통제합니다.", "햄스트링 범위: 목과 허리에 과한 긴장이 들어가지 않게 안정적으로 유지합니다.", "둔근으로 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("허리가 말리면 즉시 범위를 줄이세요.", "무거운 중량보다 등 중립을 우선하세요."), 3, 8..10, null, 90),
        ...
        exercise("calf_raise", "카프 레이즈", MuscleGroup.LOWER_BODY, EquipmentType.MACHINE, DifficultyLevel.BEGINNER, "calf_raise", "종아리 근육을 단순하고 안전하게 자극합니다.", listOf("발 위치: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "올리기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "멈추고 내리기: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("짧게 튕기지 말고 끝범위를 사용하세요.", "발목 통증이 있으면 범위를 줄이세요."), 3, 12..15, null, 60),
        ...
        exercise("seated_cable_row", "시티드 케이블 로우", MuscleGroup.BACK, EquipmentType.CABLE, DifficultyLevel.BEGINNER, "seated_cable_row", "등 중앙과 자세 안정에 도움이 되는 수평 당기기 운동입니다.", listOf("허리 세팅: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "팔꿈치 당기기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "견갑 통제 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("상체를 크게 젖혀 반동을 만들지 마세요.", "어깨를 으쓱하지 마세요."), 3, 8..12, null, 90),
        ...
        exercise("bird_dog", "버드독", MuscleGroup.CORE, EquipmentType.BODYWEIGHT, DifficultyLevel.BEGINNER, "dead_bug", "등과 골반 안정성을 함께 기르는 코어 운동입니다.", listOf("네발기기: 손은 어깨 아래, 무릎은 골반 아래에 두고 목부터 골반까지 길게 정렬합니다.", "한쪽 뻗기: 한쪽 팔과 반대쪽 다리를 길게 뻗고 골반이 돌아가거나 허리가 꺾이지 않게 버팁니다.", "복귀 후 반대쪽: 천천히 네발기기 자세로 돌아온 뒤 반대쪽 팔과 다리도 같은 방식으로 반복합니다."), listOf("허리를 꺾어 다리를 높이지 마세요.", "천천히 균형을 잡으세요."), 2, 8..10, null, 60),
        ...
        exercise("cable_woodchop", "케이블 우드찹", MuscleGroup.CORE, EquipmentType.CABLE, DifficultyLevel.INTERMEDIATE, "plank", "코어와 몸통 회전을 통제하며 쓰는 운동입니다.", listOf("상단 풀리 시작: 케이블을 높은 위치에 두고 손잡이를 어깨 위쪽에서 잡아 몸통을 길게 세웁니다.", "대각선 당기기: 팔만 휘두르지 말고 가슴과 골반을 함께 돌리며 손잡이를 대각선 아래로 당깁니다.", "무릎 바깥 마무리: 손잡이를 반대쪽 무릎 바깥 방향까지 내리고 복부에 힘을 유지합니다.", "통제 복귀: 케이블이 끌고 가게 두지 말고 같은 대각선 경로로 천천히 돌아온 뒤 반대쪽도 반복합니다."), listOf("허리만 급하게 비틀지 마세요.", "통증이 있으면 팔로프 프레스로 대체하세요."), 2, 10..12, null, 60),
        ...
        exercise("glute_bridge", "글루트 브릿지", MuscleGroup.LOWER_BODY, EquipmentType.BODYWEIGHT, DifficultyLevel.BEGINNER, "leg_press", "엉덩이 수축을 배우기 좋은 낮은 난이도 운동입니다.", listOf("누운 자세: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "골반 올리기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "둔근 수축 후 하강: 통증 없는 범위에서 천천히 움직이고 반동을 쓰지 않습니다."), listOf("허리를 과하게 꺾지 마세요.", "목과 어깨에 힘을 주지 마세요."), 3, 10..15, null, 60),
        exercise("cable_glute_kickback", "케이블 글루트 킥백", MuscleGroup.LOWER_BODY, EquipmentType.CABLE, DifficultyLevel.INTERMEDIATE, "leg_press", "엉덩이 뒤쪽 수축을 집중해서 느끼는 보조 운동입니다.", listOf("스트랩 연결: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "뒤로 밀기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "골반 고정 복귀: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다."), listOf("허리 반동으로 차지 마세요.", "가벼운 무게로 가동 범위를 먼저 잡으세요."), 2, 10..15, null, 60),
        exercise("hip_abduction_machine", "힙 어브덕션 머신", MuscleGroup.LOWER_BODY, EquipmentType.MACHINE, DifficultyLevel.BEGINNER, "leg_press", "엉덩이 측면과 골반 안정에 도움을 주는 머신 운동입니다.", listOf("바깥 패드 맞추기: 양 무릎과 허벅지 바깥쪽이 패드에 닿게 앉고 몸통을 세웁니다.", "바깥으로 벌리기: 바깥쪽 패드를 밀어 양 무릎을 대칭으로 벌립니다.", "중앙으로 복귀: 패드가 튕기지 않게 통제하며 시작 위치로 돌아옵니다."), listOf("상체를 크게 흔들지 마세요.", "엉덩이 옆쪽 느낌이 사라지면 중량을 낮추세요.", "어덕션처럼 안쪽 패드를 모으는 동작과 혼동하지 마세요."), 2, 12..15, null, 60),
        exercise("hip_adduction_machine", "힙 어덕션 머신", MuscleGroup.LOWER_BODY, EquipmentType.MACHINE, DifficultyLevel.BEGINNER, "leg_press", "허벅지 안쪽을 안전하게 보조 강화하는 운동입니다.", listOf("벌린 시작 자세: 다리를 벌린 상태에서 허벅지 안쪽 패드가 양쪽 다리에 붙어 있는지 확인합니다.", "안쪽으로 모으기: 패드가 다리에서 떨어지지 않게 양 무릎을 중앙으로 모읍니다.", "열린 자세로 복귀: 패드가 튕기지 않도록 천천히 벌어진 시작 자세로 돌아갑니다."), listOf("가동 범위를 억지로 넓히지 마세요.", "골반이 들리거나 허리가 뜨지 않게 하세요.", "패드가 허벅지에서 떨어지면 중량을 낮추고 범위를 줄이세요."), 2, 12..15, null, 60),
        exercise("back_extension", "백 익스텐션", MuscleGroup.LOWER_BODY, EquipmentType.MACHINE, DifficultyLevel.INTERMEDIATE, "back_extension", "둔근과 허리 주변을 통제해서 강화하는 후면 체인 운동입니다.", listOf("패드 위치: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "등 중립: 목과 허리에 과한 긴장이 들어가지 않게 안정적으로 유지합니다.", "상체 접기: 통증 없는 범위에서 천천히 움직이고 반동을 쓰지 않습니다.", "둔근으로 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("허리를 뒤로 과하게 젖히지 마세요.", "허리 통증이 있으면 제외하세요."), 2, 10..12, null, 90),
        exercise("straight_arm_pulldown", "스트레이트 암 풀다운", MuscleGroup.BACK, EquipmentType.CABLE, DifficultyLevel.BEGINNER, "straight_arm_pulldown", "팔꿈치를 거의 편 상태로 광배근 감각을 익히는 운동입니다.", listOf("케이블 높이: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "허벅지 쪽 당기기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "광배 긴장 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("허리를 젖혀 당기지 마세요.", "팔꿈치를 과하게 굽히면 로우가 됩니다."), 2, 10..15, null, 60),
        exercise("machine_row", "머신 로우", MuscleGroup.BACK, EquipmentType.MACHINE, DifficultyLevel.BEGINNER, "machine_row", "궤도가 안정되어 초보자가 등 당기기를 익히기 좋은 운동입니다.", listOf("패드·손잡이 조정: 장비와 몸의 기준점을 맞춘 뒤 호흡을 정리합니다.", "당기기: 목표 근육에 힘을 유지하고 몸통이 흔들리지 않게 움직입니다.", "통제 복귀: 같은 경로로 천천히 돌아와 다음 반복을 준비합니다."), listOf("어깨를 으쓱하지 마세요.", "반동으로 몸을 뒤로 젖히지 마세요."), 3, 8..12, null, 90),
        ...
        exercise("side_plank", "사이드 플랭크", MuscleGroup.CORE, EquipmentType.BODYWEIGHT, DifficultyLevel.BEGINNER, "side_plank", "옆구리와 골반 안정성을 기르는 코어 운동입니다.", listOf("팔꿈치 위치: 팔꿈치를 어깨 바로 아래에 두고 옆으로 누워 다리를 길게 뻗습니다.", "골반 들어 일직선: 팔꿈치와 발 옆면으로 지지하며 골반을 들어 머리부터 발끝까지 일직선을 만듭니다.", "호흡 유지: 골반이 떨어지지 않게 버티며 목과 허리에 과한 긴장이 들어가지 않게 호흡합니다."), listOf("어깨 통증이 있으면 시간을 줄이세요.", "골반이 뒤로 빠지지 않게 하세요.", "허리가 꺾이면 무릎을 대고 진행하세요."), 2, null, 1, 60),
